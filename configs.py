...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6992512716:AAE6pNZkfKXjjoG8yI08JjXs2wIHW_2BeSg")
	BOT_USERNAME = os.environ.get("BOT_USERNAME","EsmFilestream_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL","-1002004732514"))
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL","-1002126482175")
